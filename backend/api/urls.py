...
from .views import (DatasetLabelIndexView, DatasetLabelView, DatasetNameView,
                    RawDataView, getContributionResultView,
                    getLearningRateSchedulerView, getModelResultView,
                    getModelView, getOptimizersView, startRunModelView)
...
urlpatterns = [
    ...
    path(
        "api/getLearningRateScheduler",
        getLearningRateSchedulerView.as_view(),
        name="learning rate scheduler name",
    ),
    path(
        "api/getContributionResult",
        getContributionResultView.as_view(),
        name="learning contribution result",
    ),
]
